...
A modern AI chat interface built with Next.js, Vercel AI SDK, and Tailwind CSS.

## Features

- 💬 **AI Integration**: Powered by `@ai-sdk/react` and OpenAI.
- 📝 **Markdown Support**: Rich text rendering for AI responses using `react-markdown`.
